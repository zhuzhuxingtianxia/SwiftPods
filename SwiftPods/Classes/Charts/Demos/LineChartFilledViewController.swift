...
class LineChartFilledViewController: DemoBaseViewController {
    ...
    func setDataCount(_ count: Int, range: UInt32) {
        ...
        set1.highlightColor = .orange//UIColor(red: 244/255, green: 117/255, blue: 117/255, alpha: 1)
        ...
        set2.highlightColor = .purple//UIColor(red: 244/255, green: 117/255, blue: 117/255, alpha: 1)
